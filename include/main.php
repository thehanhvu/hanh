...
<?
    ...
    <div class="row no-padding">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tieude no-padding"><a href="index.php?xem=danhmuc&iddanhmuc=<? echo $rs["idDanhMuc"];?>"><i class="glyphicon glyphicon-th"></i> <? echo $rs["tenDanhMuc"];?></a>
        </div>
    </div>
	<div class="row">
        <? $sql1 = "select * from sanpham where idDanhMuc ='$rs[idDanhMuc]' order by idSanPham DESC limit 0,4";
			...
			while ($rs1 = mysql_fetch_array($tb1)){?>
				<div class="col-sm-3 col-md-3 col-lg-3 main1 thumbnail">
                    <div class="image"><a href="index.php?xem=chitiet&idsanpham=<? echo $rs1["idSanPham"];?>"><img class="img-rounded" src="<? echo $rs1["hinhAnh"];?>" width="100%" /></a></div>
